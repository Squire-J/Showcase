...
var UserManager = /** @class */ (function () {
    ...
    /* Get user from DB */
    UserManager.prototype.getUser = function (userID, db) {
        console.log('Get user');
        return db.collection('users').find({ _id: Number(userID) }).toArray();
    };
    /* Method to get all the users from the DB */
    UserManager.prototype.getAllUsers = function (db) {
        console.log('getAllUsers()');
        return db.collection('users').find().toArray();
    };
    /* Method to add a new user. Returns the id of the new user */
    UserManager.prototype.addUser = function (db) {
        return __awaiter(this, void 0, void 0, function () {
            var currentMaxID, toAdd;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, db.collection('users').find().sort({ _id: -1 }).limit(1).toArray()];
                    case 1:
    ...
    UserManager.prototype.removeUser = function (userID, db) {
